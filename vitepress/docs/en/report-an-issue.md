...
* Go to <https://github.com/QiuChenly/CoreInject/issues/new>
* Copy and paste the template below
* Replace the curly braces and square brackets with actual content
...
Have you used tools such as OpenCore Legacy Patcher that require modifying system files?
...
- enter {...}
- click {...}
- the software will crash / quit unexpectedly.
