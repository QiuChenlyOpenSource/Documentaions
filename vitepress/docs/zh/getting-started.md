...
如果你在使用过程中遇到任何问题，可以参考 [报告问题](./report-an-issue) 部分在 GitHub 上提出详细问题。
...
请访问 [App 支持状态一览表](./app-support-list) 查阅。
...
- [Adobe](./special-apps/adobe)
- [Setapp](./special-apps/setapp)
- [Sublime](./special-apps/sublime)
